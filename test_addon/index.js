...
var queryCreate = 	"CREATE TABLE IF NOT EXISTS COMPANY(ID INT PRIMARY KEY NOT NULL, NAME TEXT NOT NULL,\
					 AGE INT NOT NULL, ADDRESS CHAR(50), SALARY REAL, FILE  BLOB );";
var querysToInsert = "INSERT INTO COMPANY (ID,NAME,AGE,ADDRESS,SALARY,FILE)\
					 VALUES (1, 'Paul', 32, 'California', 20000.00, ? );\
					 INSERT INTO COMPANY (ID,NAME,AGE,ADDRESS,SALARY,FILE)\
